...
test_that("ppa_cluster.data.frame - ES_idx not in ES.", {
  expect_error(
    ES |>
      ppa_cluster(P, ES_idx = "foo"),
...
test_that("ppa_cluster.data.frame - P is a vector that does not match any column in ES.", {
  expect_error(
    ES |>
      dplyr::bind_cols(P) |>
      ppa_cluster(c("foo")),
...
test_that("ppa_cluster.data.frame - P is a vector that match the ES_idx column in ES.", {
  expect_error(
    ES |>
      dplyr::bind_cols(P) |>
      ppa_cluster(c("cell_id"),
                 ES_idx = "cell_id"),
    "P does not contains species names."
  )
})

test_that("ppa_cluster.data.frame - cell_id of P does not join any row in ES", {
...
test_that("ppa_cluster.data.frame - P is a vector that match the ES_idx column in ES.", {
  expect_error(
    ES |>
      ppa_cluster(P |> dplyr::filter(sp1 > 0)),
    "It was not possible to bind columns from ES and P"
  )
})

test_that("ppa_cluster.data.frame - ES is a dataframe with 0 rows", {
  expect_error(
    ES |>
...
test_that("ppa_cluster.data.frame - ES is a dataframe with 0 columns", {
  expect_error(
    ES |>
...
test_that("ppa_cluster.data.frame - P is null", {
  expect_error(
    ES |>
      ppa_cluster(NULL),
...
test_that("ppa_cluster.data.frame - P is a dataframe with 0 rows", {
  expect_error(
    ES |>
      ppa_cluster(
...
test_that("ppa_cluster.data.frame - P is a dataframe with 0 columns", {
  expect_error(
    ES |>
      ppa_cluster(
...
test_that("ppa_cluster.data.frame - P is a vector and ES_idx not informed.", {
  expect_snapshot(
    ppa <- ES |>
...
test_that("ppa_cluster.data.frame - P is a vector and ES_idx is informed and remove_Es_idx is T.", {
  expect_snapshot(
    ppa <- ES |>
      dplyr::bind_cols(P) |>
      ppa_cluster(
...
test_that("ppa_cluster.data.frame - P is a vector and ES_idx is informed and remove_Es_idx is F.", {
  expect_snapshot(
    ppa <- ES |>
      dplyr::bind_cols(P) |>
      ppa_cluster(
...
test_that("ppa_cluster.data.frame - P is a DF and ES_idx not informed.", {
  expect_snapshot(
    ppa <- ES |>
      dplyr::select(-cell_id) |>
      ppa_cluster(
...
test_that("ppa_cluster.data.frame - P is a DF and ES_idx is informed and remove_Es_idx is T.", {
  expect_snapshot(
    ppa <- ES |>
      ppa_cluster(
        P,
...
test_that("ppa_cluster.data.frame - P is a DF and ES_idx is informed and remove_Es_idx is F.", {
  expect_snapshot(
    ppa <- ES |>
      ppa_cluster(
        P,
...
test_that("ppa_cluster.data.frame - Throws 2 different errors to 3 species.", {
  expect_snapshot(
    ppa <- ES |>
      dplyr::bind_cols(P) |>
      dplyr::filter(sp1>0) |>
